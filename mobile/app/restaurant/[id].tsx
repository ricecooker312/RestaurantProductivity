import { View, Text, TouchableWithoutFeedback, Image, Alert, FlatList, ScrollView, ActivityIndicator } from 'react-native'
        ...
        return (
            <View className='flex-1 bg-dfbg'>
                <SafeAreaView style={{
                    ...
                    <ActivityIndicator className='mr-auto ml-auto' size={'large'} color={'#292626'} />
                </SafeAreaView>
            </View>
        )
    } else {
                ...
                <SafeAreaView style={{
                    ...
                    >
                        ...
                        <View style={{ flexShrink: 1 }}>
                            {restaurant.filter(item => item.type === 'furniture').length > 0 ? (
                                <FlatList
                                ...
                                />
                            ) : <Text className='ml-6'>No furniture items</Text>}
                        </View>

                        <Text className='m-6 mt-12 text-xl font-bold color-dark-heading'>Menu</Text>
                        <View style={{ flexShrink: 1 }}>
                            {restaurant.filter(item => item.type === 'menu').length > 0 ? (
                                <FlatList
                                ...
                                />
                            ) : <Text className='ml-6'>No menu items</Text>}
                        </View>

                        <Text className='m-6 mt-12 text-xl font-bold color-dark-heading'>Decor</Text>
                        <View style={{ flexShrink: 1 }}>
                            {restaurant.filter(item => item.type === 'decor').length > 0 ? (
                                <FlatList 
                                ...
                                />
                            ) : <Text className='ml-6 text-lg'>No decor items</Text>}
                        </View>
                    </ScrollView>
                </SafeAreaView>
            </View>
